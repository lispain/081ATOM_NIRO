...
class kegman_conf():
  def __init__(self, CP=None):
    ...
    self.init = { 
        ...
        "sR_KPH": [0,],
        "sR_BPV": [[-5,0,5],],
        "sR_lqr_kiV": [[0.02,0.02,0.02],],
        "sR_lqr_scaleV": [[1800,2000,1800],],
        "sR_pid_KpV": [[0.25,0.25,0.25],],
        "sR_pid_KiV": [[0.02,0.02,0.02],],
        "sR_pid_KdV": [[1.5,1.5,1.5],],
        "sR_pid_deadzone": 0.1,
        "sR_steerRatioV": [[15.3,15.6,15.3],],
        "sR_ActuatorDelayV": [[0.1,0.2,0.1]],
        "steerLimitTimer": 0.8,
        "steerOffset": 0.0,
        "steerRateCost": 0.8,
        "cameraOffset": 0.00
